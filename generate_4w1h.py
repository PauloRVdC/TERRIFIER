...
from trenchant_utils import period_year
...
del df['WeekYearCornTrend']
del df['MonthYearCornTrend']
del df['WeekYearSoyTrend']
del df['MonthYearSoyTrend']
...
print(list(df['WeekYearCornTrend'].unique()))
print(list(df['MonthYearCornTrend'].unique()))
print(list(df['WeekYearSoyTrend'].unique()))
print(list(df['MonthYearSoyTrend'].unique()))
